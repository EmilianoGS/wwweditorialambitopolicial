					...
					<div id="bb-bookblock" class="bb-bookblock">
							...
							<div class="Pagina">
				             ...
				             <div class="Pagina">
					          ...
					          <img src="imagenes3/dcha/ambito_MARZO2021-01.jpg" id="imagenesder" width="481" height="658" alt="image02"/>
							...
							<?php
								for($num=1;$num<18; $num++){
                                    ...
                                    <div class="Pagina">                                    
                                        <img src="imagenes3/izq/ambito_MARZO2021-0'.$num.'.jpg" id="imagenesizq" width="481" height="658" alt="image02"/>
                                    </div>
                                    <div class="Pagina">
                                        <img src="imagenes3/dcha/ambito_MARZO2021-0'.($num+1).'.jpg" id="imagenesder" width="685" height="1000" id="imagenesder" alt="image02"/>
                                    </div>  
                                </div>';
                                    }  
                                    else{
