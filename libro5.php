				...
				<div id="revista">
					...
					<div id="bb-bookblock" class="bb-bookblock">
						<div class="bb-item">
					       ...
					       <img src="imagenes4/retiracion2.jpg" id="imagenesizq" alt="image02"/>
				             ...
				             <div class="Pagina">
					          ...
					          <img src="imagenes5/tapa.jpg" width="685" height="1000" id="imagenesder" alt="image02"/>
							...
							<div class="Pagina">
					          ...
					          <img src="imagenes5/izq/retiracion.jpg" id="imagenesizq" alt="image02"/>
				              
				             </div>
				             <div class="Pagina">
				              
					          <img src="imagenes5/dcha/pagina1.jpg" width="685" height="1000" id="imagenesder" alt="image02"/>
						...
						for($num=2;$num<51; $num=$num+2){
							...
							<div class="Pagina">                                    
								<img src="imagenes5/izq/pagina'.$num.'.jpg" id="imagenesizq" width="481" height="658" alt="image02"/>
							</div>
							<div class="Pagina">
								<img src="imagenes5/dcha/pagina'.($num+1).'.jpg" id="imagenesder" width="685" height="1000" id="imagenesder" alt="image02"/>
							</div>  
						</div>';
                            }
							else{
