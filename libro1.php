	...
	<div id="contenedor2">
			...
			<div class="main clearfix" style="padding-left:0 !important;">
				...
				<div id="revista"><nav id="pasadorpag">
	                ...
	                <div class="NuevaPagina bb-item tmb">
								<div class="Pagina">                                    
									<img src="imagenes1/antetapas.jpg" id="imagenesizq" />
								</div>
								<div class="Pagina">
									<img src="imagenes1/tapa.jpg" id="imagenesder" />
								</div>  
							</div>
						<?php 
							for($i=2;$i<53; $i=$i+2){
							if($i<52){
								echo '<div class="NuevaPagina bb-item tmb">
								<div class="Pagina">                                    
									<img src="imagenes1/pag'.$i.'.jpg" id="imagenesizq" />
								</div>
								<div class="Pagina">
									<img src="imagenes1/pag'.($i+1).'.jpg" id="imagenesder" />
								</div>  
							</div>';
							}	
							else{
