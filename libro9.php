				...
				<div id="revista">
					...
					<div id="bb-bookblock" class="bb-bookblock">
						<div class="bb-item">
				            ...
				            <div class="Pagina">
					              <img src="imagenes9/tapa.jpg" width="685" height="1000" id="imagenesder" alt="image02"/>
				            </div>  
						</div>
						<div class="bb-item">
							<div class="Pagina">
					           <img src="imagenes9/izq/pagina1.jpg" id="imagenesizq" alt="image02"/>
				            </div>
				            <div class="Pagina">
					          <img src="imagenes9/dcha/pagina2.jpg" width="685" height="1000" id="imagenesder" alt="image02"/>
				            </div>  
						</div>

						<?php
						    for($num=3;$num<51; $num=$num+2){
                                echo '<div class="otraClase bb-item tmb">
                                <div class="Pagina">                                    
                                    <img src="imagenes9/izq/pagina'.$num.'.jpg" id="imagenesizq" width="481" height="658" alt="image02"/>
                                </div>
                                <div class="Pagina">
                                    <img src="imagenes9/dcha/pagina'.($num+1).'.jpg" id="imagenesder" width="685" height="1000" id="imagenesder" alt="image02"/>
                                </div>  
                          	  </div>';
						...
						?>
							...
							<div class="bb-item">
                                <div class="Pagina">
                                 <img src="imagenes9/izq/pagina51.jpg" id="imagenesizq" alt="image02"/>
                                </div>                               
					     	</div>
					</div>
				</div> <!--Fin div Revista-->	
