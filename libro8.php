...
AMBITO POLICIAL</h1><h5>Publicación Independiente y de Interés General<br>
			...
			<div class="container" style="float: none !important;">
				  	
     
			<!-- Top Navigation -->
			<div class="main clearfix" style="padding-left:0 !important;">
				...
				<div id="revista">
					...
					<div id="bb-bookblock" class="bb-bookblock">
						<div class="bb-item">
				            ...
				            <div class="Pagina">
					              <img src="imagenes8/tapa.jpeg" width="685" height="1000" id="imagenesder" alt="image02"/>
				            </div>  
						</div>
						<div class="bb-item">
							<div class="Pagina">
					           <img src="imagenes8/izq/pagina2.jpeg" id="imagenesizq" alt="image02"/>
				            </div>
				            <div class="Pagina">
					          <img src="imagenes8/dcha/pagina3.jpeg" width="685" height="1000" id="imagenesder" alt="image02"/>
				            </div>  
						</div>

						<?php
						    for($num=4;$num<51; $num=$num+2){
                                echo '<div class="otraClase bb-item tmb">
                                <div class="Pagina">                                    
                                    <img src="imagenes8/izq/pagina'.$num.'.jpeg" id="imagenesizq" width="481" height="658" alt="image02"/>
                                </div>
                                <div class="Pagina">
                                    <img src="imagenes8/dcha/pagina'.($num+1).'.jpeg" id="imagenesder" width="685" height="1000" id="imagenesder" alt="image02"/>
                                </div>  
                          	  </div>';
						...
						?>
							...
							<div class="bb-item">
                                <div class="Pagina">
                                 <img src="imagenes8/izq/pagina52.jpeg" id="imagenesizq" alt="image02"/>
                                </div>                               
					     	</div>
					</div>
				</div> <!--Fin div Revista-->	
