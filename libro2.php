...
<html lang="en" class="no-js demo-1">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="librosStyle.css" />
...
<body>
	<div id="contenedor2">
			<div id="titulorevista"><h1>REVISTA<br>AMBITO POLICIAL</h1><h5>Publicación Independiente y de Interés General<br>
			...
			<div class="main clearfix" style="padding-left:0 !important;">
				...
				<div id="revista"><nav id="pasadorpag">
					...
					<div id="bb-bookblock" class="bb-bookblock">
						<div class="bb-item">
							<div class="Pagina">
					          	<img src="imagenes2/retiracion.jpg" id="imagenesizq" alt="image02"/>
				               
				             </div>
				             <div class="Pagina">
				             
					          <img src="imagenes2/tapa.jpg" id="imagenesder" width="481" height="658" alt="image02"/>
				              
				             </div>  
						</div>
						<?php

                        for($num=2;$num<53; $num=$num+2){
                            if($num<52){
                                echo '<div class="bb-item tmb">
                            <div class="Pagina">                                    
                                <img src="imagenes2/ap'.$num.'.jpg" id="imagenesizq" width="481" height="658" alt="image02"/>
                            </div>
                            <div class="Pagina">
                                <img src="imagenes2/ap'.($num+1).'.jpg" id="imagenesder" width="685" height="1000" id="imagenesder" alt="image02"/>
                            </div>  
                        </div>';
                            }  
                            else{
